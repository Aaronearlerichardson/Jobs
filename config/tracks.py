...
filter defaults that flip on switch (webapp/routes.py), plus the crawl
methodology scrapers/runner.py runs it with. The tables are data and live
here; the building logic is core/tracks.py.
...
# Kept under its old name: tests and scrapers/runner.py reach it via config.
