...
The web UI (src/ops/background.py), the maintenance CLI (run_scraper.py) and the
...
REGISTRY = {
    ...
    "crawl": {
        ...
        "target": "src.crawl.runner:run_track",
        "params": [
            _TRACK,
    ...
    "sync": {
        "label": "Sync statuses",
        "engine": None,
        "target": "src.ops.maintenance:sync_status_all",
        "params": [Param("top", "top_n", "int", 15), _TRACK],
    },
    "verify": {
        "label": "Deep-verify top N",
        "engine": None,
        "target": "src.ops.maintenance:verify_top_cli",
    ...
    "rescore": {
        "label": "Rescore all",
        "engine": None,
        "target": "src.ops.maintenance:rescore_all",
    ...
    "backfill-descriptions": {
        ...
        "engine": None,
        "target": "src.ops.maintenance:backfill_board_descriptions",
    ...
    "backfill-axes": {
        ...
        "engine": None,
        "target": "src.ops.roster:backfill_axes",
        "params": [_TRACK],
    ...
    "prune": {
        ...
        "engine": None,
        "target": "src.ops.roster:prune",
        "params": [Param("offmission", kind="bool", default=False), _TRACK],
    },
    "dedup": {
        "label": "Dedup companies",
        "engine": None,
        "target": "src.ops.roster:dedup",
        "params": [_TRACK],
    },
    "add-job": {
        "label": "Add manual job",
        "engine": None,
        "target": "src.ops.maintenance:add_manual_job",
    ...
    "discover-local": {
        ...
        "engine": "local",
        "target": "src.discovery.local_sourcing:populate_companies",
        "params": [Param("no_dork", "dork", "not", False)],
    },
    "dork": {
        "label": "ATS dork sweep",
        "engine": "local",
        "target": "src.ops.roster:dork_sweep",
        "params": [],
    },
    "discover-term": {
        "label": "Discover companies by term",
        "engine": "local",
        "target": "src.ops.roster:discover_term",
    ...
    "score-missions": {
        ...
        "engine": "local",
        "target": "src.discovery.local_sourcing:score_missions",
        "params": [Param("rescore", "rescore_all", "bool", False)],
    },
    "add-board": {
        "label": "Add company board",
        "engine": "local",
        "target": "src.discovery.local_sourcing:add_board",
    ...
    "resolve-leads": {
        ...
        "engine": "local",
        "target": "src.discovery.local_sourcing:resolve_leads",
