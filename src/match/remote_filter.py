...
Side-effect-free: the sweep runner (src/crawl/runner.py) stamps
`remote_signal` / `_us_eligible` on its rows with it, src.match.locality.geo_mode
...
from src.match.filters import SHORT_REMOTE, token_in
