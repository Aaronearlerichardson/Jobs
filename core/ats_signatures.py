...
no network and no imports from discovery/ or scrapers/ -- so both the
...
# live count (discovery.probes / ADP requisition API). ADP needs two params
...
def detect(text, final_url=""):
    ...
    # registered by hand — see discovery.local_sourcing.add_board.
