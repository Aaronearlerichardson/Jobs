...
class TestWebappOps:
    ...
    def test_a_failing_op_logs_the_failure_line_at_error(self, tmp_path):
        """The web-UI '[!] operation failed:' line used to print to stdout,
        which reads as an ordinary WARNING ('[!]' prefix) in the session
