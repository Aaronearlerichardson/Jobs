...
Previously each of local_fetch, local_sourcing, sniffer, ats_dork, and
local_clinical carried its own NC-token regex; they now delegate here.
"""
...
def is_nc(text):
    ...
    return bool(_NC_RE.search(text or ""))
